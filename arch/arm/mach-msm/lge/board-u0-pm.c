...
#if 1 /* LGE_CHANGE_S  [yoonsoo.kim@lge.com] 20111006 :  U0 Rev.B don't use Sub PMIC*/
	.sda_pin=57,  /*YOONSOO_TEMP 20111006 : 57 not use pin. need to change*/
	.scl_pin=58,  /*YOONSOO_TEMP 20111006 : 58 not use pin. need to change*/
#else
	.sda_pin = 13,
	.scl_pin = 14,
#endif /* LGE_CHANGE_E [yoonsoo.kim@lge.com] 20111006 */
};
