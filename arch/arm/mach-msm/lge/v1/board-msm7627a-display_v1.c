...
#define MSM7x25A_MSM_FB_SIZE    0x078000		// bohyun.jung@lge.com, 256*320*2*3 (resolution * 16bit * tripple buffer)
...
void __init msm_fb_add_devices(void)
{
	...
	if (machine_is_msm7627a_qrd1())
	...
	else if (machine_is_msm7627a_evb() || machine_is_msm8625_evb() || machine_is_msm8625_evt()) {
		...
		mdp_pdata.cont_splash_enabled = 0x0;
		platform_add_devices(qrd3_fb_devices, ARRAY_SIZE(qrd3_fb_devices));
	} else {
		mdp_pdata.cont_splash_enabled = 0x0;
		platform_add_devices(msm_fb_devices, ARRAY_SIZE(msm_fb_devices));
	}
	...
	if (machine_is_msm7625a_surf() || machine_is_msm7x27a_surf() ||
		machine_is_msm8625_surf() || machine_is_msm7627a_qrd3() || machine_is_msm8625_qrd7())
		msm_fb_register_device("lcdc", &lcdc_pdata);
#ifdef CONFIG_FB_MSM_MIPI_DSI
	msm_fb_register_device("mipi_dsi", &mipi_dsi_pdata);
#endif
	if (machine_is_msm7627a_evb() || machine_is_msm8625_evb() || machine_is_msm8625_evt()) {
