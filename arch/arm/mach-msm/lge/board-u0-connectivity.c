...
static struct platform_device *u0_connectivity_devices[] __initdata = {
#ifdef CONFIG_BT
	&msm_bt_power_device,
#endif
};
...
void __init lge_add_connectivity_devices(void)
{
	...
	platform_add_devices(u0_connectivity_devices,
		ARRAY_SIZE(u0_connectivity_devices));
