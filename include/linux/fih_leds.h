...
//#include "../../arch/arm/mach-msm/proc_comm.h" //MTD-SW3-PERIPHERAL-OH-LED_Porting-00-

// Don't modify anything!!!
#define	LED_HW_PMIC_GPIO		0
#define	LED_HW_PMIC_MPP		1
#define	LED_HW_MSM_GPIO		2
#define LED_HW_PMIC_LPG     3 //MTD-SW3-PERIPHERAL-OH-LED_Porting-00+
...
#define LED_COMMAND_FADE_IN_OUT_TIME_DIFF 32 //MTD-SW3-PERIPHERAL-BJ-LED_FADE_IN_OUT_DIFF-00*
...
{
	char			*name;
	struct pwm_device *pwm_dev; //MTD-SW3-PERIPHERAL-OH-LED_Porting-00+
	struct mutex		lock;
	unsigned int		use_hw;
