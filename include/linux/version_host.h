...
#define VER_HOST_BSP_VERSION     "3034"          //(4 digits, Dec.).
#define VER_HOST_PLATFORM_NUMBER "42"            //(2 digits, Dec.). i.e. 2.0/2.1(Eclair);2.2(Froyo) ...
#define VER_HOST_BRANCH_NUMBER   "29"            //(2 digits, Dec.)
