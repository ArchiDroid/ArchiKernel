...
#if defined(CONFIG_ZRAM_FOR_ANDROID) && !defined(CONFIG_ARCHIKERNEL_TARGET_SYSTEM_HAS_NO_ZRAM_GOVERNOR)
				...
				gfp_t gfp_mask, nodemask_t *nodemask)
{
	...
	struct scan_control sc = {
		...
		.may_unmap = 1,
#if (defined(CONFIG_ZRAM_FOR_ANDROID) || defined(CONFIG_DIRECT_RECLAIM_FILE_PAGES_ONLY)) && !defined(CONFIG_ARCHIKERNEL_TARGET_SYSTEM_HAS_NO_ZRAM_GOVERNOR)
		.may_swap = 0,
#else
		.may_swap = 1,
#endif /* CONFIG_ZRAM_FOR_ANDROID */
