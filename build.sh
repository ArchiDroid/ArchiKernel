...
TOOLCHAIN="$HOME/TC" # This is where your toolchain is located
TARGETZIPDIR="$HOME/shared/kernel/e610" # If valid, output zip will be moved there from default TARGETDIR location
...
SUGGESTED_TOOLCHAIN="https://github.com/ArchiDroid/Toolchain/tree/architoolchain-5.2-arm-linux-gnueabihf" # Suggested toolchain for this variant of AK
