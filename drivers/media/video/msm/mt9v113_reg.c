...
//[ min frame]
 ...
 struct mt9v113_i2c_reg_conf const refreshmode_sub[] =
{   
        {0x098C, 0xA103},                                 
        {0x0990, 0x0006}, 
 };
 struct mt9v113_i2c_reg_conf const refresh_sub[] =
{   
        {0x098C, 0xA103},                                 
        {0x0990, 0x0005}, 
 };

  struct mt9v113_i2c_reg_conf const additional_setting_sub[] =
{   
...
struct mt9v113_i2c_reg_conf const scene_normal_mode_tbl_sub[]=
{	
       {0x098C, 0xA20C},
       {0x0990, 0x0009},
       {0x098C, 0xA75D},
...
struct mt9v113_i2c_reg_conf const scene_night_mode_tbl_sub[]=
{	
       {0x098C, 0xA20C},
...
struct mt9v113_reg mt9v113_regs = {
	...
	.refreshmode = &refreshmode_sub[0],
	.refreshmode_size = ARRAY_SIZE(refreshmode_sub), 

	.refresh = &refresh_sub[0],
	.refresh_size = ARRAY_SIZE(refresh_sub), 
	...
	/* Scene mode*/
	.scene_normal_mode_tbl = &scene_normal_mode_tbl_sub[0],
	.scene_normal_mode_tbl_size = ARRAY_SIZE(scene_normal_mode_tbl_sub),
	.scene_night_mode_tbl = &scene_night_mode_tbl_sub[0],
	.scene_night_mode_tbl_size = ARRAY_SIZE(scene_night_mode_tbl_sub),
