...
extern struct hi542_reg hi542_regs;

struct hi542_i2c_reg_conf {
	unsigned short waddr;
	unsigned char wdata;
};

enum hi542_test_mode_t {
	TEST_OFF,
	TEST_1,
	TEST_2,
	TEST_3
...
struct hi542_reg {
	const struct hi542_i2c_reg_conf *reg_mipi;
	const unsigned short reg_mipi_size;
	const struct hi542_i2c_reg_conf *rec_settings;
	const unsigned short rec_size;
	const struct hi542_i2c_reg_conf *reg_pll_p;
	const unsigned short reg_pll_p_size;
	const struct hi542_i2c_reg_conf *reg_pll_s;
	const unsigned short reg_pll_s_size;
	const struct hi542_i2c_reg_conf *reg_prev;
	const unsigned short reg_prev_size;
	const struct hi542_i2c_reg_conf *reg_snap;
