...
struct mt9v113_reg {
	...
	struct mt9v113_i2c_reg_conf const *refreshmode;
	uint16_t refreshmode_size;

	struct mt9v113_i2c_reg_conf const *refresh;
	...
	uint16_t fps_auto_730_tbl_size;
      //scene
	struct mt9v113_i2c_reg_conf const *scene_normal_mode_tbl;
	uint16_t scene_normal_mode_tbl_size;
	struct mt9v113_i2c_reg_conf const *scene_night_mode_tbl;
	uint16_t scene_night_mode_tbl_size;
