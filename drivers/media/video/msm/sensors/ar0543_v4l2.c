...
static struct msm_camera_i2c_reg_conf ar0543_recommend_settings[] = {
...
static struct msm_camera_i2c_reg_conf ar0543_recommend_settings_1[] = {
...
static struct msm_camera_i2c_conf_array ar0543_init_conf[] = {
	{&ar0543_recommend_settings[0],
	ARRAY_SIZE(ar0543_recommend_settings), 1, MSM_CAMERA_I2C_WORD_DATA},//Delay 1ms
       {&ar0543_recommend_settings_1[0],
	ARRAY_SIZE(ar0543_recommend_settings_1), 0, MSM_CAMERA_I2C_WORD_DATA},
};
