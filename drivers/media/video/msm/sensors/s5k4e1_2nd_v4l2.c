...
/* MM-UW-ImplementRegSwitchMechanismForShading-00+{ */
static struct msm_camera_i2c_reg_conf s5k4e1_2nd_recommend_settings1[] = {
    {0x0100, 0x00},
    {0x3030, 0x06},
...
static struct msm_camera_i2c_conf_array s5k4e1_2nd_init_conf[] = {
	{&s5k4e1_2nd_recommend_settings2[0],/* MM-UW-ImplementRegSwitchMechanismForShading-00* */
	ARRAY_SIZE(s5k4e1_2nd_recommend_settings2), 0, MSM_CAMERA_I2C_BYTE_DATA}
};
...
int32_t S5k4e1_2nd_match_id(struct msm_sensor_ctrl_t *s_ctrl)
{
      int32_t rc = 0;
      int32_t productid = 0;
      int32_t shading_index = 0;/* MM-UW-ImplementRegSwitchMechanismForShading-00+ */
      uint16_t chipid = 0;
    ...
    if (s_ctrl->sensor_i2c_addr == 0x20)/* MM-MC-ImplementOtpReadFunctionForS5k4E1_2ND-00* */
    {
        ...
        {
            s5k4e1_2nd_init_conf[0].conf = &s5k4e1_2nd_recommend_settings1[0];
            s5k4e1_2nd_init_conf[0].size = ARRAY_SIZE(s5k4e1_2nd_recommend_settings1);
            s5k4e1_2nd_init_conf[0].delay = 0;
            s5k4e1_2nd_init_conf[0].data_type = MSM_CAMERA_I2C_BYTE_DATA;
            printk("S5k4e1_2nd_match_id: Load shading setting for golden module !\n");
        }
        else
            printk("S5k4e1_2nd_match_id: shading_index = %d, Load shading setting for corner module !\n", shading_index);
        /* MM-UW-ImplementRegSwitchMechanismForShading-00+} */
    }
...
/* MM-UW-ImplementRegSwitchMechanismForShading-00+{ */
int32_t S5k4e1_2nd_get_output_info(struct msm_sensor_ctrl_t *s_ctrl,
		struct sensor_output_info_t *sensor_output_info)
{
    ...
    printk("S5k4e1_2nd_get_output_info: shading_index = %d !\n", shading_index);
...
static struct msm_sensor_fn_t s5k4e1_2nd_func_tbl = {
	...
	.sensor_get_output_info = S5k4e1_2nd_get_output_info,/* MM-UW-ImplementRegSwitchMechanismForShading-00+ */
