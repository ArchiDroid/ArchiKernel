...
static int __init mipi_cmd_lg4572b_hvga_pt_init(void)
{
	int ret;

#ifdef CONFIG_FB_MSM_MIPI_PANEL_DETECT
	if (msm_fb_detect_client("mipi_cmd_lg4572b_hvga"))
		return 0;
#endif
	...
	ret = mipi_lg4572b_device_register(&pinfo, MIPI_DSI_PRIM,
...
module_init(mipi_cmd_lg4572b_hvga_pt_init);
