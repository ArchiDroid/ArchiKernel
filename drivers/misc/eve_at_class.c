...
#if 0
void update_vlc_state(struct atcmd_dev *sdev, int state)
{
	char name_buf[120];
	char state_buf[120];
	char *prop_buf;
...
// BEGIN: 0004336 eternalblue@lge.com:2010-02-24
// MOD: 0004336: [ARM9] AT CMD module in kerne did not process same state command.
//	if (sdev->state != state) 
// END: 0004336:eternalblue@lge.com:2010-02-24
	{
		sdev->state = state;
		sdev->name = cmd;
...
MODULE_DESCRIPTION("eve_atcmd class driver");
MODULE_LICENSE("GPL");
