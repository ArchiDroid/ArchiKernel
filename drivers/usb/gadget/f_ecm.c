...
ecm_bind_config(struct usb_configuration *c, u8 ethaddr[ETH_ALEN])
{
	...
	if (ecm_string_defs[0].id == 0) {
...
#ifdef CONFIG_LGE_USB_GADGET_DRIVER
		/* WARNING : Donot change order of usb_string_id() below this code */
		/* string descriptor for MAC Addr. should 5 for LG PC USB Driver */
		/* MAC address */
		...
		pr_info(" *** iMACAddress = %x\n", status); // status value should 5
#endif
